...
På kjøkkenveggen: [kalender. Alle avtaler ført med samme håndskrift. Det er ikke Ellings.](fact:f_kalender)

I kjøleskapet (Grete viste meg, uoppfordret, som et bevis): [middagsbokser merket med ukedager, mandag til søndag.](fact:f_matbokser) «Han varmer dem selv.» Det hørtes ut som et forsvar.
...
Appears on: f_grete_baerer, f_trygd, f_husleie
...
Appears on: f_gap, f_leie_stoppet, f_husleie
...
Appears on: f_grete_baerer, f_klarer_seg
...
Appears on: f_bok, f_utklipp, f_matbokser, f_aldri_alene
...
Appears on: f_elling_tlf, f_avstand, f_ingen_tjenester
...
Needs hypothesis: h_ok_grete, h_b_sikres, h_c_penger
...
Needs hypothesis: h_h_infra, h_h_system, h_k_oppmote, h_c_kontakt
...
Cost: 1
Needs: f_matbokser
Needs hypothesis: h_h_infra, h_c_mat
...
Cost: 1
Needs: f_post
Needs hypothesis: h_ok_unngaar, h_k_skriftlig, h_h_infra
...
Cost: 0
Needs: f_post
Needs hypothesis: h_h_kanmer, h_s_trenbar, h_s_ukjent
...
Cost: 0
Needs: f_saarbar
Needs hypothesis: h_s_formell, h_press_institusjon
...
Good segment: Funksjoner overført
Good size: 6
Bad segment: Alt går via Grete
Bad size: 6
...
Good segment: Tar imot og håndterer
Good size: 4
Bad segment: Presset for hardt
Bad size: 4
...
Bad segment: Levering blir stående
Bad size: 4
