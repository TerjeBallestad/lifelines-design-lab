# Case: case_olsen_sb317_draft
Title: Olsen — SB-317 spørsmåls-rewrite (UTKAST)
Scenario stage: 0
Vurdering frist day: 10
...
Supports: q_evner
Discuss: Frank
Reveals questions: q_evner, q_vekst
...
Supports: q_evner
Discuss: Frank
Reveals questions: q_evner, q_liv
...
Supports: q_kollaps
Discuss: Frank
Reveals questions: q_kollaps, q_liv
...
Opens tiltak: t_hjemmehjelp, t_dokgjennomgang
...
## h_ev_kanmer
Title: Mer enn det ser ut. Grete har bare alltid rukket det først.
Summary: Konsentrasjon, arkiv og system er observert. Kapasiteten er ikke testet — den er utkonkurrert.
Question: q_evner
...
Good label: Funksjoner overført
Good size: 6
Bad label: Alt går via Grete
Bad size: 6
...
Good label: Tar imot og håndterer
Good size: 4
Bad label: Presset for hardt
Bad size: 4
...
Good size: 4
Bad label: Levering blir stående
Bad size: 4
